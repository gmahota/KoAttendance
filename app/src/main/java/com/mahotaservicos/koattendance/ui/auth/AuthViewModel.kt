...
import com.mahotaservicos.koattendance.api.*
import com.mahotaservicos.koattendance.api.AddHeaderInterceptor
import com.mahotaservicos.koattendance.api.ApiInterface
import com.mahotaservicos.koattendance.api.MessageResponse
import com.mahotaservicos.koattendance.data.Employee
import com.mahotaservicos.koattendance.helper.round
...
//                    }
    ...
    /// [START Send Phone Verify With USend]
    private fun PhoneVerifyUsendit(phoneNumber: String,smsCode :Int ) {
        try{
            ...
            var valueEventListener = object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if(myList.count() > 0){
                        ...
                        _explanation3.value = "Please check if your cellphone is connect to the internet and click again on Validate \n!" +
